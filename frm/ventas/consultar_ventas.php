...
<body id="main">
                ...
                <div class="card-body">
                    <div class="row mb-2">
                        ...
                        <div class="col-md-3 mt-4">
                            <button type="button" class="btn btn-primary cargar" onclick="cargarVentas()">
                                <i class="fa fa-upload"></i> Consultar</button>
                        </div>
                    </div>
                    <div class="table-responsive">
                        <table id="ventas" class="table table-bordered table-hover w-100">
                            <thead>
                                <tr>
        ...
        <div class="modal-dialog fixed-top modal-dialog-scrollable">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="row">
                        <h3 id="cliente" class="text-center">Cliente...</h3>
                        <span id="factura" class="fs-5"></span>
                        <span id="cajero" class="fs-5"></span>
                        <span id="fecha" class="fs-5"></span>
                        <span id="total" class="fs-5"></span>
                    </div>
                    <div class="table-responsive">
                        <table id="detalle_venta" class="table table-hover w-100 table-striped">
                            <thead>
                                <tr>
                                    <th class="text-end" style="width: 1%;">CANT</th>
                                    <th>ARTÍCULO</th>
    ...
    <!-- Modal Registrar Pago de Venta -->

    <div class="modal fade" id="modalPagoVenta" data-bs-backdrop="static" data-bs-keyboard="true" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog fixed-top modal-dialog-scrollable">
            <div class="modal-content">
                <div class="modal-header">
