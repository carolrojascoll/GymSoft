...
siguienteClick($("#f_nacimiento"), $("#check"), false);
...
function cargarTabla() {
    ...
    clientes = $('#datos_clientes').DataTable({
        ...
        "order": [],
        "ajax": {
            url: "../../funciones_php/clientes/cargar_clientes.php",
            type: "POST"
        },
        "columnDefs": [
            {
    ...
    clientes.on('draw.dt', function () {
        clientes.column(0).visible(false);
    });
...
function cargarComboCiudades() {
    ...
    $.ajax({
        type: 'POST',
        url: '../../funciones_php/clientes/combo_ciudades.php',
        dataType: 'json',
